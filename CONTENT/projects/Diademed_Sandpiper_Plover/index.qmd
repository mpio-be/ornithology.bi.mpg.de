...
![Lagunas de Vilama, Argentina, photo by Bruce Lyon](Fig1.jpg){group="group-1"}

![El Yeso Valley, Chile](Fig2.jpg){group="group-1"}
...
![Termas del Plomo at the end of the El Yeso Valley](Fig4.jpg){group="group-1"}

![Ultra high resolution (\~15cm<sup>2</sup> pixel) satellite image of the Termas del Plomo](Fig5.jpg){group="group-1"}
...
![Field team at the El Yeso Valley, Chile](Fig6.jpg){group="group-1"}
