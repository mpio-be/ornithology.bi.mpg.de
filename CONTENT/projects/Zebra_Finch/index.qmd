...
date: "2004-11-01" # date when the project started
categories: [ongoing] 
image: "about.webp"
...
![Zebra finches (from left to right): domesticated male, wild-derived female, wild-derived male, domesticated female.](Fig1.webp)
...
![A successful copulation of male ‘light-blue’ with female ‘light-blue’ on the courtship perch.](Fig2.webp)
...
![A male zebra finch carrying a backpack fitted with a QR-code for automated tracking.](Fig3.webp)
...
![The remarkable absence of assortative mating by phenotypic quality in the zebra finch (taken from Wang et al. 2017b https://dx.doi.org/10.1111/evo.13341).](Fig4.webp)
...
![Love marriages” have higher fitness than “arranged marriages” in the zebra finch (taken from [@ihleFitnessBenefitsMate2015] ).](Fig5.webp)
...
![The data points show machine-learning-based estimates of whether a male’s song belongs to the same dialect (blue) with which a female grew up, or to a different dialect (red). These estimates are powerful predictors of female mate choice (taken from [@wangMachineLearningReveals2022] ).](Fig6.webp)
...
![Genetic correlations in fitness traits tend to be negative (blue) between males and females (MF) and between offspring and adult males (OM), suggesting that antagonistic pleiotropy is more common than good-gene variation in fitness traits (taken from [@peiPeiYiFanProximateCausesInfertility2020])](Fig7.webp)
...
![Heterosis caused by an inversion polymorphism on the male sex-chromosome (Z), which also shows large effects on sperm morphology and velocity (taken from [@kniefSexchromosomeInversionCauses2017]).](Fig8.webp)
...
![Presence of a GRC (pink) inside of one out of two sperm heads (blue), taken from [@peiOccasionalPaternalInheritance2022] . ](Fig9.webp)


![GRC haplotypes (right) are not co-inherited with mitochondrial haplotypes (left), taken from [@peiOccasionalPaternalInheritance2022] . ](Fig10.webp)
