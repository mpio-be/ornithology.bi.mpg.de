...
![Global distribution of plumage lightness across all passerine birds. Warmer colours indicate bird assemblages with lighter plumage colours.](Fig2.webp){fig-align="center" width=80% group="proj-color"}  
...
![The predicted proportion of broods with extra-pair offspring across the breeding range of the Blue Tit (*Cyanistes caeruleus*). Populations for which EPP estimates are available are marked in red.](Fig7.webp){fig-align="center" width=80% group="proj-epp"}
...
![Global distribution of the proportion of extra-pair broods at assemblage-level.](Fig8.webp){fig-align="center" width=80% group="proj-epp"}
...
![Extra-pair paternity predicts sexual dimorphism in avian species.](Fig9.webp){fig-align="center" width=80% group="proj-epp"}
...
![Distribution of peak song frequency across passerines around the globe.](Fig10.webp)
...
![Global distribution of the number of species (i.e. species richness) for day-active avian predators.](Fig12.webp)
